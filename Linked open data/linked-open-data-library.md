...
The following library can be used to transform (to and from) SPARQL queries and json objects: _[github](https://github.com/LinkedDataFragments/Client.js).
The library is written for nodejs but can be used in the browser by using browserify.
