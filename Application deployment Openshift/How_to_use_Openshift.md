...
* Note: You can find the URL, where your application is hosted, in the web console > **Applications** > **Services** and there you can choose the right service. (Refer to step 5 to enable a hostname and a route)
